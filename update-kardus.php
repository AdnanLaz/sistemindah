                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Update Data Kardus</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Input Transaksi Kardus</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="main-content-inner">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Input Transaksi Kardus</h4>
                                <form action="proses/proses_kardus.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Kardus Saat Ini</label>
                                        <input class="form-control" type="number" min="0" name="jmlkardusm" placeholder=" <?php include 'proses/koneksi.php'; $query="SELECT SUM(jmlkardusm - jmlkardusk) AS totalkardus FROM kardus"; $result = mysqli_query($konek, $query);$row = mysqli_fetch_assoc($result);$total_kardus = $row['totalkardus'];echo $total_kardus;?>" id="example-text-input" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Kardus Masuk</label>
                                        <input class="form-control" type="number" min="0" name="jmlkardusm" placeholder="Jumlah Kardus Masuk" id="example-text-input" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Kardus Keluar</label>
                                        <input class="form-control" type="number" max="<?php include 'proses/koneksi.php'; $query="SELECT SUM(jmlkardusm - jmlkardusk) AS totalkardus FROM kardus"; $result = mysqli_query($konek, $query);$row = mysqli_fetch_assoc($result);$total_kardus = $row['totalkardus'];echo $total_kardus;?>" name="jmlkardusk" placeholder="Jumlah Kardus Keluar" id="example-text-input" required>
                                    </div>
                                    <div class="form-group">

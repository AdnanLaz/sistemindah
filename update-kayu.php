                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Update Data Kayu</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Input Transaksi Kayu</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="main-content-inner">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Input Transaksi Kayu</h4>
                                <form action="proses/proses_kayu.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Kayu Saat Ini</label>
                                        <input class="form-control" type="number" min="0" name="jmlkayum" placeholder=" <?php include 'proses/koneksi.php'; $query="SELECT SUM(jmlkayum - jmlkayuk) AS totalkayu FROM kayu"; $result = mysqli_query($konek, $query);$row = mysqli_fetch_assoc($result);$total_kayu = $row['totalkayu'];echo $total_kayu;?>" id="example-text-input" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Kayu Masuk</label>
                                        <input class="form-control" type="number" min="0" name="jmlkayum" placeholder="Jumlah Kayu Masuk" id="example-text-input" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Kayu Keluar</label>
                                        <input class="form-control" type="number" max="<?php include 'proses/koneksi.php'; $query="SELECT SUM(jmlkayum - jmlkayuk) AS totalkayu FROM kayu"; $result = mysqli_query($konek, $query);$row = mysqli_fetch_assoc($result);$total_kayu = $row['totalkayu'];echo $total_kayu;?>" name="jmlkayuk" placeholder="Jumlah Kayu Keluar" id="example-text-input" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Keterangan</label>
                                        <input class="form-control" type="text" name="ket" placeholder="Keterangan" id="example-text-input" required>
                                    </div>
                                    <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Kirim</button>
                                </form>
                            </div>
                        </div>
                    </div>

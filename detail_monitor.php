                  ...
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="" color="yellow">Detail Pemantauan Pengiriman</a>
                        </div>
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h4 class="pageheader-title">Detail Pemantauan Pengiriman </h4>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Dashboard</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Detail Pemantauan Pengiriman</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <?php
                            ...
                            $nomv = $_GET['nomvdl'];
                            include "koneksi.php";
                            $cek = mysqli_query($konek, "SELECT * FROM manivestpengantaran WHERE nomvdl='$nomv'");
                                    ...
                                    <div class="form-group row">
                                        <table class="table table-hover">
                                            ...
                                            <?php
                                                ...
                                                include "koneksi.php";
                                                $cek = mysqli_query($konek, "SELECT * FROM inputdata JOIN manivestpengantaran ON manivestpengantaran.noresi = inputdata.noresi WHERE nomvdl='$nomv'");

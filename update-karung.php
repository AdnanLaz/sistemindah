                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Update Data Karung</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.html">Home</a></li>
                                <li><span>Input Transaksi Karung</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="main-content-inner">
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Input Transaksi Karung</h4>
                                <form action="proses/proses_karung.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Karung Saat Ini</label>
                                        <input class="form-control" type="number" min="0" name="jmlkarungm" placeholder=" <?php include 'proses/koneksi.php'; $query="SELECT SUM(jmlkarungm - jmlkarungk) AS totalkarung FROM karung"; $result = mysqli_query($konek, $query);$row = mysqli_fetch_assoc($result);$total_karung = $row['totalkarung'];echo $total_karung;?>" id="example-text-input" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Karung Masuk</label>
                                        <input class="form-control" type="number" min="0" name="jmlkarungm" placeholder="Jumlah Karung Masuk" id="example-text-input" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-text-input" class="col-form-label">Jumlah Karung Keluar</label>
                                        <input class="form-control" type="number" max="<?php include 'proses/koneksi.php'; $query="SELECT SUM(jmlkarungm - jmlkarungk) AS totalkarung FROM karung"; $result = mysqli_query($konek, $query);$row = mysqli_fetch_assoc($result);$total_karung = $row['totalkarung'];echo $total_karung;?>" name="jmlkarungk" placeholder="Jumlah Karung Keluar" id="example-text-input" required>
                                    </div>
                                    <div class="form-group">
